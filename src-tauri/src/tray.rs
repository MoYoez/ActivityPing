...
fn tray_text(locale: &str, key: TrayText) -> &'static str {
    ...
    match (english, key) {
        ...
        (false, TrayText::MainWindowNotFound) => "Main window not found.",
        (false, TrayText::Show) => "Open main window",
        (false, TrayText::Hide) => "Hide to background",
        (false, TrayText::Quit) => "Quit app",
        (false, TrayText::CreateMenuFailed) => "Failed to create the tray menu",
        (false, TrayText::LoadIconFailed) => "Failed to load the tray icon",
        (false, TrayText::CreateTrayFailed) => "Failed to create the system tray",
    }
}
